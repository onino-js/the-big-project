import styles from "./pass-science.module.scss";
...
const PassScience = () => {
  return (
    <div className={cx("pass-science")}>
      <div className={cx("fade-in")}>
        <h3>Le Popo logique du lemme en panne</h3>
        ...
        <br />
        Patatra ! Le vernis fut ! l'Est à portée de patte !<br />
        Lalala ma libellule ! Les new Qui ? sont en la ZAD !
        <br />
        Gnagnagna, Gulliver nu ! Reprends donc le porte à porte
        <br />
        ...
        <br />
        Tête de nœuds ou nœuds de tête % &gt;&gt;&gt; jamais miroir sans son
        &lt;&lt;&lt;
        <br />
        Si cette drôle de nature (69) se résume d'un coup de chatte $$$
        <br />
        Seul le tricot assure §§§ Une et unique écharpe @@@
        <br />
        L’Ascience est belle quette !? Éternelle son les Agathes. )))
      </div>
      <br />
      <br />
      <br />
